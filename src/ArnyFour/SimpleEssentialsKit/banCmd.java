...
public class banCmd implements CommandExecutor{
	...
	public banCmd(Essentials plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		p.kickPlayer("You are " + ChatColor.DARK_RED + "BANNED"+ ChatColor.WHITE +" by "+ ChatColor.GOLD + admin + ChatColor.WHITE +"\nReason: "+ ChatColor.RED + reason);
		Bukkit.getBanList(Type.NAME).addBan(name, reason, null, "Ban");
		sender.sendMessage(ChatColor.GRAY + "[" + ChatColor.GOLD + "SimpleEssentials"+ ChatColor.GRAY +"] " + ChatColor.GREEN +"Player "+ChatColor.DARK_GREEN+name+ChatColor.GREEN+" was been banned!");
		return true;
	}
